...
colourCols = c("PainS_NopainA", "value", "")
legendTitles = c("PainS_NopainA", "Cytokine", "")
...
assessment = assessNumComponents(processedGeorgiou$data, minNumComponents, maxNumComponents, numRepetitions, ctol=ctol, maxit=maxit, numCores=numCores)

assessment$plots$overview

modelStabilityCheck(processedGeorgiou, numComponents=1, numFolds=numFolds, considerGroups=TRUE,
                               groupVariable="PainS_NopainA", colourCols, legendTitles, xLabels, legendColNums, arrangeModes,
