...
% Remove outliers
df_cnt_scl_filtered([39 52],:,:) = [];
df_cnt_scl_filtered(:,:,5) = [];
subjectMeta_filtered([39 52],:) = [];
...
%%
% Save the models
model_path = "./20230905_run_firstDerivative/PARAFAC models/";
...
path_start = "./20230905_run_firstDerivative/Figures/";
